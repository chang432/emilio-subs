...
const ReviewCard = ({logo, stars, review, author, pic}) => {
    return (
        <div className="w-full flex flex-row flex-wrap bg-black justify-center md:justify-evenly items-center p-28 text-xs md:text-md text-center md:text-left">
            <div className="flex flex-col justify-evenly space-y-5 mb-8 md:mb-0">
                <div className="flex flex-row space-x-5 justify-center md:justify-normal">

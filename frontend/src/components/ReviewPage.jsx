...
const ReviewPage = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center space-y-0.5 my-0.5 mx-0.5">
            <h1 className="text-6xl py-20 w-full text-center text-white bg-black">Reviews</h1>
